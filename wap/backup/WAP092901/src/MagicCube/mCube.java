...
public class mCube {
	...
	public mCube(int len, int[] values) {
		super();
		this.length = len;
	...
	public boolean equals(mCube compare){
		boolean result = true;
	...
	public mCube subCube(int z, int y, int x, int length) {
		...
		mCube subCube = new mCube(length, values);
		return subCube;
	}
}
